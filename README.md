...
- Z niewiadomego powodu transformacja xyz2plh daje błędne wyniki h, co jest jeszcze dziwniejsze, gdy plik z otrzymanymi wynikami tej transformacji (te w błędnym h) weźmiemy do transformacji plh2xyz to otrzymane wyniki są poprawne. Sprawdzone to zostało na przykładzie elipsoidy WRS84, gdzie wyniki z transformacji plh2xyz powinny dać te same współrzędne co dane do transformacji xyz2plh. Otrzymane wyniki są sobie równe, jednak nadal w wynikach xyz2plh jest błąd w h oraz różnice po przecinku w phi i lam. Sam kod transformacji sprawdzony został w innym pliku i przy innych współrzędnych i tam pokazywał poprawne wyniki xyz2plh oraz plh2xyz. Nie wiadome jest czemu w programie tak się dzieje.
